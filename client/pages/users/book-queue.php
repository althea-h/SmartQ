            ...
            try {
                ...
                if (count($schedules) > 0) {
                    foreach ($schedules as $row) {
                        ...
                        echo '
                        <div class="student-card schedule-item">
                          <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px;">
                            <div class="schedule-date" style="display: flex; flex-direction: column;">
                              <span style="font-size: 1.5rem; font-weight: 800; color: var(--student-primary);">'.$day.'</span>
                              <span style="font-size: 0.8rem; color: #64748b; font-weight: 600; text-transform: uppercase;">'.$monthYear.'</span>
                            </div>
                            <div style="text-align: right;">
                              <span style="display: block; font-size: 0.75rem; color: #94a3b8; font-weight: 600; text-transform: uppercase;">Availability</span>
                              <span style="font-size: 0.95rem; font-weight: 700; color: '.($available > 10 ? '#22c55e' : '#ef4444').';">'.$available.' Slots Left</span>
                            </div>
                          </div>
                          ...
                          <div style="margin-bottom: 20px;">
                            ...
                            <div style="height: 6px; background: #f1f5f9; border-radius: 99px; overflow: hidden;">
                              <div style="width: '.$percentage.'%; height: 100%; background: var(--student-primary); border-radius: 99px;"></div>
                            </div>
                          </div>';
